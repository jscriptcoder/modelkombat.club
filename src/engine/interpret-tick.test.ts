...
describe("runTick — numeric reads", () => {
  it.each<[FieldPath, StateOverrides, number]>([
    ...
    ["self.y", { self: { y: 24000 } }, 24000],
    ["self.vy", { self: { vy: -4000 } }, -4000],
    ...
    ["opponent.senshu", { opponent: { senshu: 1 } }, 1],
...
describe("runTick — rule(path) ruleset reads", () => {
  ...
  it.each<[string, number, number]>([
    ...
    ["moves.uraken.startup", 7, 0],
    ["moves.uraken.active", 2, 0],
    ["moves.uraken.recovery", 13, 0],
    ["moves.uraken.score", 1, 0],
    ["moves.uraken.reach", 200000, 0],
    ["moves.uraken.staminaCost", 12, 0],
    ["moves.shuto.startup", 8, 0],
    ["moves.shuto.active", 2, 0],
    ["moves.shuto.recovery", 15, 0],
    ["moves.shuto.score", 1, 0],
    ["moves.shuto.reach", 260000, 0],
    ["moves.shuto.staminaCost", 22, 0],
    ["moves.yoko-geri.startup", 12, 0],
    ["moves.yoko-geri.active", 3, 0],
    ["moves.yoko-geri.recovery", 20, 0],
    ...
    ["moves.empi.startup", 8, 0],
    ["moves.empi.active", 2, 0],
    ["moves.empi.recovery", 14, 0],
