# BotBout — Bot DSL v2 (deep karate)

> **Status:** PROPOSED — the concrete API synthesized from the locked combat
> decisions in `docs/COMBAT-DESIGN.md`. Awaiting review. Supersedes the lean
> `docs/BOT-DSL.md` (v1, historical). This doc doubles as the **prompt context**
> handed to an LLM to author a bot.
