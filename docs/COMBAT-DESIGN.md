...
> **Status:** Living spec, in active design (via `grill-me`). The **LOCKED** section
> below is decided; the **PROPOSED** sections are my recommendations awaiting your
> sign-off as the interview continues. Each new decision gets written back here.
> **Last updated:** 2026-06-21
>
> **Relationship to other docs:** This supersedes the *lean 4-move v1* combat
> model in `docs/DESIGN.md` and `docs/BOT-DSL.md` (now the historical baseline).
> The **non-negotiable invariants** in `CLAUDE.md` (determinism, DSL-as-data TCB,
> integer math, same-snapshot resolution) still hold and are *extended*, not
> replaced. Karate move design is salvaged from **Project Pixel Fist**
> (`docs/move-taxonomy.md`, `docs/design-brief.md`, `docs/character-rig.md` there).
...
### P5/P6. DSL action grammar + state schema — ✓ RESOLVED → see `docs/BOT-DSL-v2.md`
...
(finalized in `docs/BOT-DSL-v2.md`):
...
- ✓ P5/P6 DSL synthesis — **resolved** → `docs/BOT-DSL-v2.md`
