...
**Status**: ✅ COMPLETE — both slices merged (#303, #304) and live. Archived 2026-07-15.

## Goal

Turn the `/ring` page into the deliberate two-step the platform now supports: a submit runs a
footprint-free **practice** projection (where the bot _would_ land), and a separate, deliberate
...
**Value**: A human couriering an iterating LLM sees where the bot _would_ land and only crowns when they
...
_Archived under `docs/archive/` on completion (repo convention — never delete)._
