...
> ✅ **ARC COMPLETE (2026-07-20) — archived in the arc closeout.** Decisions 1–10 + mechanics **M1–M14**
> are all shipped across S0–S8. This is the historical decisions record; see `docs/STATUS.md` item 9 and
> `docs/archive/README.md` for the closeout narrative, and `docs/archive/move-poses-stories.md` for the
> split record.
