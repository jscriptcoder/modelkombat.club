...
Slice 1 wiring PR #117 → benchmark v5, Slice 2 `rule()` readers PR #118 → no bump; plan
archived at `archive/uraken-backfist.md`). Next: `shuto`. Living source of truth for the
